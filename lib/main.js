/*!
FullCalendar Scheduler v5.0.0-beta.1
...
(function (global, factory) {
  ...
  */
  ...
  function parseToolbars(allOptions, theme, isRtl, calendar) {
      ...
      var header = allOptions.header ? parseToolbar(allOptions.header, theme, isRtl, calendar, viewsWithButtons) : null;
      var footer = allOptions.footer ? parseToolbar(allOptions.footer, theme, isRtl, calendar, viewsWithButtons) : null;
      return { header: header, footer: footer, viewsWithButtons: viewsWithButtons };
  }
  ...
  */
  ...
  var CalendarComponent = /** @class */ (function (_super) {
      ...
      */
      CalendarComponent.prototype.render = function (props, state, context) {
          var calendar = context.calendar, options = context.options, header = context.header, footer = context.footer;
          ...
          return (h(d, null,
              header &&
                  h(Toolbar, __assign({ ref: this.headerRef, extraClassName: 'fc-header-toolbar', model: header }, toolbarProps)),
              ...
              footer &&
                  h(Toolbar, __assign({ ref: this.footerRef, extraClassName: 'fc-footer-toolbar', model: footer }, toolbarProps))));
      };
  ...
  // Outer Div Rendering
  // -----------------------------------------------------------------------------------------------------------------
  function reportClassNames(onClassNameChange, forPrint, dir, theme) {
      onClassNameChange(computeClassNames(forPrint, dir, theme));
  }
  // NOTE: can't have any empty! caller gets confused
  function computeClassNames(forPrint, dir, theme) {
      var classNames = [
          'fc',
      ...
      */
      Calendar.prototype.mutateOptions = function (updates, removals, isDynamic) {
          ...
          for (var name_2 in normalUpdates) {
              if (/^(defaultDate|defaultView)$/.test(name_2)) ;
              else {
  ...
  */
  ...
  var TableDateCell = /** @class */ (function (_super) {
      ...
      TableDateCell.prototype.render = function (props, state, context) {
          ...
          var navLinkData = (options.navLinks && !dayMeta.isDisabled && props.colCnt > 1)
              ...
              : null;
          var hookProps = __assign(__assign(__assign({ date: dateEnv.toDate(date), view: context.view }, props.extraHookProps), { text: text,
              navLinkData: navLinkData }), dayMeta);
          return (h(RenderHook, { name: 'dayHeader', hookProps: hookProps, defaultContent: renderInner }, function (rootElRef, customClassNames, innerElRef, innerContent) { return (h("th", __assign({ ref: rootElRef, className: classNames.concat(customClassNames).join(' '), "data-date": !dayMeta.isDisabled ? formatDayString(date) : undefined, colSpan: props.colSpan > 1 ? props.colSpan : undefined }, props.extraDataAttrs), innerContent)); }));
      };
  ...
  var TableDowCell = /** @class */ (function (_super) {
      ...
      TableDowCell.prototype.render = function (props, state, context) {
          ...
          var text = dateEnv.format(date, props.dayHeaderFormat);
          var hookProps = __assign(__assign(__assign(__assign({ date: date }, dateMeta), { view: context.view }), props.extraHookProps), { text: text, navLinkData: null });
          return (h(RenderHook, { name: 'dayHeader', hookProps: hookProps, defaultContent: renderInner }, function (rootElRef, customClassNames, innerElRef, innerContent) { return (h("th", __assign({ ref: rootElRef, className: classNames.concat(customClassNames).join(' '), colSpan: props.colSpan > 1 ? props.colSpan : undefined }, props.extraDataAttrs), innerContent)); }));
      };
      return TableDowCell;
  }(BaseComponent));
  function renderInner(hookProps) {
      if (!hookProps.isDisabled) {
          return (h("a", { "data-navlink": hookProps.navLinkData }, hookProps.text));
      }
  }
  ...
  var Slicer = /** @class */ (function () {
      ...
      */
      Slicer.prototype.sliceEventRange = function (eventRange, extraArgs) {
          var segs = this.sliceRange.apply(this, __spreadArrays([eventRange.range], extraArgs));
  ...
  */
  var RefMap = /** @class */ (function () {
      ...
      RefMap.prototype.collect = function (// TODO: check callers that don't care about order. should use getAll instead
  ...
  var CLIENT_HEIGHT_WIGGLE = /Trident/.test(navigator.userAgent) ? 1 : 0;
  ...
  var SimpleScrollGrid = /** @class */ (function (_super) {
      ...
      SimpleScrollGrid.prototype.render = function (props, state, context) {
          ...
          return (h("table", { class: classNames.join(' '), style: { height: props.height } }, sectionConfigs.map(function (sectionConfig, sectionI) { return _this.renderSection(sectionConfig, sectionI, microColGroupNode); })));
      };
      ...
      SimpleScrollGrid.prototype.renderChunkTd = function (sectionConfig, sectionI, microColGroupNode, chunkConfig) {
          ...
          var needsYScrolling = getAllowYScrolling(this.props, sectionConfig); // TODO: do lazily. do in section config?
          var isLiquid = getSectionHasLiquidHeight(this.props, sectionConfig);
          var overflowY = forceYScrollbars ? 'scroll' :
          ...
          return (h("td", { ref: chunkConfig.elRef },
              h("div", { class: 'fc-scroller-harness' + (isLiquid ? ' fc-scroller-harness-liquid' : '') },
                  h(Scroller, { ref: this.scrollerRefs.createRef(sectionI), elRef: this.scrollerElRefs.createRef(sectionI), overflowY: overflowY, overflowX: 'hidden', maxHeight: sectionConfig.maxHeight, liquid: isLiquid, liquidIsAbsolute: true /* because its within a harness */ }, content))));
      };
  ...
  var EventRoot = function (props) { return (h(ComponentContextType.Consumer, null, function (context) {
      var seg = props.seg;
      var hookProps = {
      ...
      var style = getSkinCss(seg.eventRange.ui);
      var standardClassNames = getEventClassNames(hookProps).concat(seg.eventRange.ui.classNames);
      return (h(RenderHook, { name: 'event', hookProps: hookProps, defaultContent: props.defaultContent, elRef: function (el) {
              if (el) {
                  setElSeg(el, seg);
              }
          } }, function (rootElRef, customClassNames, innerElRef, innerContent) { return props.children(rootElRef, standardClassNames.concat(customClassNames), style, innerElRef, innerContent, hookProps); }));
  })); };
  ...
  var NowIndicatorRoot = function (props) { return (h(ComponentContextType.Consumer, null, function (context) {
      ...
      return (h(RenderHook, { name: 'nowIndicator', hookProps: hookProps }, function (rootElRef, customClassNames, innerElRef, innerContent) { return props.children(rootElRef, classNames.concat(customClassNames), innerElRef, innerContent); }));
  })); };
  ...
  function massageHooksProps(input, context) {
      ...
      return __assign(__assign({ date: dateEnv.toDate(date), view: context.view }, dayMeta), { dayNumberText: input.showDayNumber ? dateEnv.format(date, DAY_NUM_FORMAT) : '', navLinkData: options.navLinks ? buildNavLinkData(date) : undefined });
  }
  ...
  */
      ...
      function TableCell() {
          ...
          _this.handleMoreLink = function (ev) {
              ...
              if (props.onMoreClick) {
                  ...
                  var hiddenSegs = allSegs.filter(function (seg) { return props.segIsNoDisplay[seg.eventRange.instance.instanceId]; });
                  props.onMoreClick({
                      date: props.date,
                      allSegs: allSegs,
  ...
  function renderCellHeaderInner(props) {
      if (props.dayNumberText) {
          return (h("a", { className: 'fc-daygrid-day-number', "data-navlink": props.navLinkData }, props.dayNumberText));
      }
  }
  ...
  var TableCellTop = /** @class */ (function (_super) {
      ...
      TableCellTop.prototype.render = function (props) {
          return (h(DayCellContent, { date: props.date, todayRange: props.todayRange, dateProfile: props.dateProfile, showDayNumber: props.showDayNumber, extraHookProps: props.extraHookProps, defaultContent: renderCellHeaderInner }, function (innerElRef, innerContent) { return (innerContent &&
              h("div", { class: 'fc-daygrid-day-top', ref: innerElRef }, innerContent)); }));
      };
      return TableCellTop;
  }(BaseComponent));
  ...
  var TableEvent = /** @class */ (function (_super) {
      ...
      TableEvent.prototype.render = function (props) {
          return (h(StandardEvent, __assign({}, props, { extraClassNames: ['fc-daygrid-event', 'fc-h-event'], defaultTimeFormat: DEFAULT_TIME_FORMAT, defaultDisplayEventEnd: props.defaultDisplayEventEnd, disableResizing: !props.seg.eventRange.def.allDay })));
      };
      return TableEvent;
  }(BaseComponent));
  ...
  function limitByMaxHeight(hiddenCnts, segIsNoDisplay, colPlacements, maxContentHeight) {
      limitEvents(hiddenCnts, segIsNoDisplay, colPlacements, true, function (placement) {
          return placement.bottom <= maxContentHeight;
      });
  }
  function limitByMaxEvents(hiddenCnts, segIsNoDisplay, colPlacements, dayMaxEvents) {
      limitEvents(hiddenCnts, segIsNoDisplay, colPlacements, false, function (placement, levelIndex) {
          return levelIndex < dayMaxEvents;
      });
  }
  function limitByMaxRows(hiddenCnts, segIsNoDisplay, colPlacements, dayMaxEventRows) {
      limitEvents(hiddenCnts, segIsNoDisplay, colPlacements, true, function (placement, levelIndex) {
  ...
  */
  function limitEvents(hiddenCnts, segIsNoDisplay, colPlacements, moreLinkConsumesLevel, isPlacementInBounds) {
      ...
      var segIsVisible = {}; // TODO: instead, use segIsNoDisplay with true/false?
      ...
      for (var col = 0; col < colCnt; col++) {
          var placements = colPlacements[col];
          for (var level = 0; level < placements.length; level++) {
              var placement = placements[level];
  ...
  var TableRow = /** @class */ (function (_super) {
      ...
      function TableRow() {
          ...
          _this.cellInnerElRefs = new RefMap();
          _this.cellContentElRefs = new RefMap();
      ...
      TableRow.prototype.render = function (props, state, context) {
          ...
          var _a = computeFgSegPlacement(props.fgEventSegs, props.dayMaxEvents, props.dayMaxEventRows, state.segHeights, state.maxContentHeight, colCnt, context.eventOrderSpecs), paddingBottoms = _a.paddingBottoms, finalSegsByCol = _a.finalSegsByCol, segsByFirstCol = _a.segsByFirstCol, segIsNoDisplay = _a.segIsNoDisplay, segTops = _a.segTops, segMarginTops = _a.segMarginTops, moreCnts = _a.moreCnts, moreTops = _a.moreTops;
          ...
          return (h("tr", null,
              ...
              props.cells.map(function (cell, col) {
                  var normalFgNodes = _this.renderFgSegs(segsByFirstCol[col], segIsNoDisplay, segTops, segMarginTops, interactionAffectedInstances, props.todayRange);
                  var mirrorFgNodes = _this.renderFgSegs(mirrorSegsByCol[col], {}, segTops, // use same tops as real rendering
                  {}, {}, props.todayRange, Boolean(props.eventDrag && props.eventDrag.segs.length), // messy check
                  ...
                  return (h(TableCell, { elRef: _this.cellElRefs.createRef(col), innerElRef: _this.cellInnerElRefs.createRef(col) /* rename */, date: cell.date, showDayNumber: props.showDayNumbers || showWeekNumber /* for spacing, we need to force day-numbers if week numbers */, showWeekNumber: showWeekNumber, dateProfile: props.dateProfile, todayRange: props.todayRange, extraHookProps: cell.extraHookProps, extraDataAttrs: cell.extraDataAttrs, extraClassNames: cell.extraClassNames, moreCnt: moreCnts[col], moreMarginTop: moreTops[col] /* rename */, buildMoreLinkText: props.buildMoreLinkText, onMoreClick: props.onMoreClick, hasEvents: Boolean(normalFgNodes.length), allFgSegs: finalSegsByCol[col], segIsNoDisplay: segIsNoDisplay, fgPaddingBottom: paddingBottoms[col], fgContentElRef: _this.cellContentElRefs.createRef(col), fgContent: [
      ...
      TableRow.prototype.componentDidUpdate = function (prevProps, prevState) {
          ...
          prevProps.cells !== currentProps.cells ||
              ...
              prevProps.showWeekNumbers !== currentProps.showWeekNumbers, prevState.cellContentPositions !== this.state.cellContentPositions);
      };
      ...
      TableRow.prototype.renderFgSegs = function (segs, segIsNoDisplay, segTops, segMarginTops, segIsInvisible, todayRange, isDragging, isResizing, isDateSelecting) {
          ...
          if (cellInnerPositions && cellContentPositions) {
              for (var _i = 0, segs_1 = segs; _i < segs_1.length; _i++) {
                  ...
                  var isAbsolute = isMirror || seg.firstCol !== seg.lastCol || !seg.isStart || !seg.isEnd; // TODO: simpler way? NOT DRY
                  ...
                  nodes.push(h("div", { class: 'fc-daygrid-event-harness' + (isAbsolute ? ' fc-daygrid-event-harness-abs' : ''), key: instanceId, ref: isMirror ? null : this.segHarnessRefs.createRef(instanceId), style: {
                      ...
                      h(TableEvent, __assign({ seg: seg, isDragging: isDragging, isResizing: isResizing, isDateSelecting: isDateSelecting, isSelected: instanceId === eventSelection, defaultDisplayEventEnd: defaultDisplayEventEnd }, getSegMeta(seg, todayRange)))));
              }
          }
          return nodes;
      };
      ...
      TableRow.prototype.updateSizing = function (isExternalSizingChange, isCellPositionsChanged) {
          if (isExternalSizingChange &&
              this.props.clientWidth !== null // positioning ready?
          ) {
              var cellInnerEls = this.cellInnerElRefs.collect();
              var cellContentEls = this.cellContentElRefs.collect();
              ...
              var segHeights = mapHash(this.segHarnessRefs.currentMap, function (eventHarnessEl) { return (eventHarnessEl.getBoundingClientRect().height); });
              this.setState({
                  maxContentHeight: (this.props.dayMaxEvents === true || this.props.dayMaxEventRows === true) ? this.computeMaxContentHeight() : null,
                  segHeights: segHeights
              });
          }
      };
      TableRow.prototype.computeMaxContentHeight = function () {
          var contentEl = this.cellContentElRefs.currentMap[0];
      ...
      MorePopover.prototype.render = function (props, state, context) {
          ...
          return (h(DayCellRoot, { date: date, todayRange: todayRange, elRef: this.handlePopoverEl }, function (rootElRef, dayClassNames, dataAttrs) { return (h(Popover, { elRef: rootElRef, title: title, extraClassNames: ['fc-more-popover'].concat(dayClassNames), extraAttrs: dataAttrs, onClose: props.onCloseClick, alignmentEl: props.alignmentEl, topAlignmentEl: props.topAlignmentEl },
              ...
              props.segs.map(function (seg) {
                  var eventRange = seg.eventRange;
                  var instanceId = eventRange.instance.instanceId;
                  return (h("div", { key: instanceId, style: {
                          visibility: hiddenInstances[instanceId] ? 'hidden' : ''
                      } },
                      h(TableEvent, __assign({ seg: seg, isDragging: false, isResizing: false, isDateSelecting: false, isSelected: instanceId === props.selectedInstanceId, defaultDisplayEventEnd: false }, getSegMeta(seg, todayRange)))));
              }))); }));
      };
  ...
  var Table = /** @class */ (function (_super) {
              ...
              h(NowTimer, { unit: 'day', content: function (nowDate, todayRange) { return [
                      h("table", { className: 'fc-scrollgrid-sync-table', style: {
                          ...
                          h("tbody", null, props.cells.map(function (cells, row) { return (h(TableRow, { ref: _this.rowRefs.createRef(row), key: cells.length
                              ...
                              , showDayNumbers: rowCnt > 1, showWeekNumbers: props.showWeekNumbers, todayRange: todayRange, dateProfile: props.dateProfile, cells: cells, renderIntro: props.renderRowIntro, businessHourSegs: businessHourSegsByRow[row], eventSelection: props.eventSelection, bgEventSegs: bgEventSegsByRow[row], fgEventSegs: fgEventSegsByRow[row], dateSelectionSegs: dateSelectionSegsByRow[row], eventDrag: eventDragByRow[row], eventResize: eventResizeByRow[row], dayMaxEvents: props.dayMaxEvents, dayMaxEventRows: props.dayMaxEventRows, clientWidth: props.clientWidth, buildMoreLinkText: buildMoreLinkText, onMoreClick: _this.handleMoreLinkClick })); }))),
      ...
      Table.prototype.prepareHits = function () {
          this.rowPositions = new PositionCache(this.rootEl, this.rowRefs.collect().map(function (rowObj) { return rowObj.cellElRefs.currentMap[0]; }), // first cell el in each row
          false, true // vertical
          );
          this.colPositions = new PositionCache(this.rootEl, this.rowRefs.currentMap[0].cellElRefs.collect(), // cell els in first row
          true, // horizontal
          false);
      };
  ...
  */
  var TimeColsSlats = /** @class */ (function (_super) {
      ...
      TimeColsSlats.prototype.updateSizing = function () {
          ...
          if (props.onCoords && props.clientWidth !== null) { // means sizing has stabilized
              props.onCoords(new TimeColsSlatsCoords(new PositionCache(this.rootElRef.current, this.slatElRefs.collect(), false, true // vertical
  ...
  var TimeColsSlatsBody = /** @class */ (function (_super) {
      ...
      TimeColsSlatsBody.prototype.render = function (props, state, context) {
          ...
          return (h("tbody", null, props.slatMetas.map(function (slatMeta, i) {
              ...
              return (h("tr", { ref: slatElRefs.createRef(i) },
                  props.axis &&
  ...
  function TimeColsAxisCell(props) {
      ...
      return (h(ComponentContextType.Consumer, null, function (context) {
          if (!props.isLabeled) {
              ...
              return (h(RenderHook, { name: 'slotLabel', hookProps: hookProps, defaultContent: renderInnerContent$2 }, function (rootElRef, customClassNames, innerElRef, innerContent) { return (h("td", { ref: rootElRef, class: classNames.concat(customClassNames).join(' '), "data-time": props.isoTimeStr },
  ...
  var TimeColEvent = /** @class */ (function (_super) {
      ...
      TimeColEvent.prototype.render = function (props) {
          return (h(StandardEvent, __assign({}, props, { defaultTimeFormat: DEFAULT_TIME_FORMAT$1, extraClassNames: ['fc-timegrid-event', 'fc-v-event'] })));
      };
      return TimeColEvent;
  }(BaseComponent));
  ...
  var TimeCol = /** @class */ (function (_super) {
      ...
      TimeCol.prototype.render = function (props, state, context) {
          var _this = this;
          var options = context.options;
          var mirrorSegs = (props.eventDrag && props.eventDrag.segs.length ? props.eventDrag.segs : null) ||
          ...
          return (h(DayCellRoot, { elRef: props.elRef, date: props.date, todayRange: props.todayRange, extraHookProps: props.extraHookProps, dateProfile: props.dateProfile }, function (rootElRef, classNames, dataAttrs) { return (h("td", __assign({ ref: rootElRef, className: ['fc-timegrid-col'].concat(classNames, props.extraClassNames || []).join(' ') }, dataAttrs, props.extraDataAttrs),
              h("div", { class: 'fc-timegrid-col-origin' },
                  h("div", { class: 'fc-timegrid-col-events' },
                      h(d, null, _this.renderFgSegs(mirrorSegs, {}, Boolean(props.eventDrag && props.eventDrag.segs.length), // messy check!
                      Boolean(props.eventResize && props.eventResize.segs.length), // messy check!
  ...
  var TimeColsContent = /** @class */ (function (_super) {
              ...
              h("table", { style: {
                  ...
                  h("tbody", null,
                      h("tr", null,
                          ...
                          props.cells.map(function (cell, i) { return (h(TimeCol, { key: cell.date.toISOString(), elRef: _this.cellElRefs.createRef(i), date: cell.date, dateProfile: props.dateProfile, nowDate: props.nowDate, todayRange: props.todayRange, extraHookProps: cell.extraHookProps, extraDataAttrs: cell.extraDataAttrs, extraClassNames: cell.extraClassNames, fgEventSegs: fgEventSegsByRow[i], bgEventSegs: bgEventSegsByRow[i], businessHourSegs: businessHourSegsByRow[i], nowIndicatorSegs: nowIndicatorSegsByRow[i], dateSelectionSegs: dateSelectionSegsByRow[i], eventDrag: eventDragByRow[i], eventResize: eventResizeByRow[i], slatCoords: props.slatCoords, eventSelection: props.eventSelection })); })))),
      ...
      TimeColsContent.prototype.updateCoords = function () {
          ...
          if (props.onColCoords && props.clientWidth !== null) { // means sizing has stabilized
              props.onColCoords(new PositionCache(this.rootElRef.current, this.cellElRefs.collect(), true, // horizontal
              false));
          }
      };
  ...
  var TimeCols = /** @class */ (function (_super) {
      ...
      TimeCols.prototype.render = function (props, state, context) {
          var dateProfile = props.dateProfile;
  ...
  var ListViewHeaderRow = /** @class */ (function (_super) {
      ...
      ListViewHeaderRow.prototype.render = function (props, state, context) {
          ...
          return (h(RenderHook, { name: 'dayHeader', hookProps: hookProps, defaultContent: renderInnerContent$3 }, function (rootElRef, customClassNames, innerElRef, innerContent) { return (h("tr", { ref: rootElRef, className: classNames.concat(customClassNames).join(' '), "data-date": formatDayString(dayDate) },
  ...
  var ListViewEventRow = /** @class */ (function (_super) {
      ...
      ListViewEventRow.prototype.render = function (props, state, context) {
          ...
          var timeFormat = createFormatter(options.eventTimeFormat || DEFAULT_TIME_FORMAT$2, options.defaultRangeSeparator);
  ...
  */
  ...
  var TimelineHeaderTh = /** @class */ (function (_super) {
      ...
      TimelineHeaderTh.prototype.render = function (props, state, context) {
          ...
          var classNames = ['fc-timeline-slot', 'fc-timeline-slot-label'].concat(getSlotClassNames(getDateMeta(cell.date, props.todayRange, props.nowDate, props.dateProfile), context.theme));
          if (cell.isWeekStart) {
          ...
          return (h(MountHook, { name: 'slotLabel', hookProps: hookProps }, function (rootElRef) { return (h("th", { ref: rootElRef, class: classNames.concat(customClassNames).join(' '), "data-date": dateEnv.formatIso(cell.date, { omitTime: !tDateProfile.isTimeScale, omitTimeZoneOffset: true }), colSpan: cell.colspan },
              h("div", { className: 'fc-timeline-slot-frame', style: { height: props.rowInnerHeight } },
                  h(TimelineHeaderThInner, __assign({}, hookPropOrigin, { isSticky: props.isSticky }))))); }));
      };
  ...
  var TimelineHeaderThInner = /** @class */ (function (_super) {
      ...
      TimelineHeaderThInner.prototype.render = function (props, state, context) {
          ...
          return (h(ContentHook, { name: 'slotLabel', hookProps: hookProps, defaultContent: renderInnerContent$4 }, function (innerElRef, innerContent) { return (h("div", { className: 'fc-timeline-slot-cushion fc-scrollgrid-sync-inner' + (props.isSticky ? ' fc-sticky' : ''), ref: innerElRef }, innerContent)); }));
      };
      return TimelineHeaderThInner;
  }(BaseComponent));
  function renderInnerContent$4(props) {
      // console.log('renderInnerContent')
      return (h("a", { "data-navlink": props.navLinkData }, props.text));
  }
  ...
  var TimelineSlatCell = /** @class */ (function (_super) {
      ...
      TimelineSlatCell.prototype.render = function (props, state, context) {
          ...
          classNames.push.apply(classNames, getSlotClassNames(dateMeta, context.theme));
  ...
  var TimelineSlats = /** @class */ (function (_super) {
      ...
      TimelineSlats.prototype.updateSizing = function () {
          ...
          if (props.clientWidth !== null) { // is sizing stable?
              this.coords = new TimelineCoords(this.rootElRef.current, this.cellElRefs.collect(), props.dateProfile, props.tDateProfile, context.dateEnv, context.isRtl);
              if (props.onCoords) {
  ...
  var TimelineSlatsBody = /** @class */ (function (_super) {
      ...
      TimelineSlatsBody.prototype.render = function (props) {
          ...
          return (h("tbody", null,
              h("tr", null, slotDates.map(function (slotDate, i) { return (h(TimelineSlatCell, { date: slotDate, dateProfile: props.dateProfile, tDateProfile: tDateProfile, nowDate: props.nowDate, todayRange: props.todayRange, isEm: isWeekStarts[i], elRef: cellElRefs.createRef(i) })); }))));
      };
  ...
  var TimelineEvent = /** @class */ (function (_super) {
      ...
      TimelineEvent.prototype.render = function (props) {
          return (h(StandardEvent, __assign({}, props, { extraClassNames: ['fc-timeline-event', 'fc-h-event'], defaultTimeFormat: DEFAULT_TIME_FORMAT$3, defaultDisplayEventTime: !props.isTimeScale, defaultContent: renderInnerContent$5 })));
      };
      return TimelineEvent;
  }(BaseComponent));
  function renderInnerContent$5(innerProps) {
      return [
          innerProps.timeText &&
              h("div", { class: 'fc-event-time' }, innerProps.timeText),
  ...
  */
  ...
  function ResourceLabelRoot(props) {
      return (h(ComponentContextType.Consumer, null, function (context) {
          ...
          return (h(RenderHook, { name: 'resourceLabel', hookProps: hookProps, defaultContent: renderInnerContent$6 }, function (rootElRef, classNames, innerElRef, innerContent) { return props.children(rootElRef, classNames, // TODO: pass in 'fc-resource' ?
  ...
  var ResourceDayHeader = /** @class */ (function (_super) {
      ...
      ResourceDayHeader.prototype.renderDayAndResourceRows = function (dates, dateFormat, todayRange, resources) {
          ...
          for (var _i = 0, dates_1 = dates; _i < dates_1.length; _i++) {
              var date = dates_1[_i];
              dateCells.push(this.renderDateCell(date, dateFormat, todayRange, resources.length));
      ...
      ResourceDayHeader.prototype.renderResourceAndDayRows = function (resources, dates, dateFormat, todayRange) {
          ...
          for (var _i = 0, resources_2 = resources; _i < resources_2.length; _i++) {
              ...
              resourceCells.push(h(ResourceCell, { key: resource.id, resource: resource, colSpan: dates.length }));
      ...
      ResourceDayHeader.prototype.renderDateCell = function (date, dateFormat, todayRange, colSpan, resource) {
          var props = this.props;
          ...
          return props.datesRepDistinctDays ?
              h(TableDateCell, { key: date.toISOString() + keyPostfix, date: date, todayRange: todayRange, dateProfile: props.dateProfile, colCnt: props.dates.length * props.resources.length, dayHeaderFormat: dateFormat, colSpan: colSpan, extraHookProps: extraHookProps, extraDataAttrs: extraDataAttrs }) :
              h(TableDowCell // we can't leverage the pure-componentness becausae the extra* props are new every time :(
              , { key: date.getUTCDay() + keyPostfix, dow: date.getUTCDay(), dayHeaderFormat: dateFormat, colSpan: colSpan, extraHookProps: extraHookProps, extraDataAttrs: extraDataAttrs });
      };
  ...
  var ResourceCell = /** @class */ (function (_super) {
      ...
      ResourceCell.prototype.render = function (props) {
          return (h(ResourceLabelRoot, { resource: props.resource, date: props.date }, function (elRef, customClassNames, dataAttrs, innerElRef, innerContent) { return (h("th", __assign({ ref: elRef, className: ['fc-col-header-cell', 'fc-resource'].concat(customClassNames).join(' '), colSpan: props.colSpan > 1 ? props.colSpan : null }, dataAttrs), innerContent)); }));
      };
      return ResourceCell;
  }(BaseComponent));
  ...
  */
  ...
  var ResourceTimelineLanes = /** @class */ (function (_super) {
      ...
      ResourceTimelineLanes.prototype.updateCoords = function () {
          ...
          if (props.onRowCoords && props.clientWidth !== null) { // a populated clientWidth means sizing has stabilized
              this.props.onRowCoords(new PositionCache(this.rootElRef.current, this.rowElRefs.collect(), false, true // isVertical
              ));
          }
      };
  ...
  var ResourceTimelineLanesBody = /** @class */ (function (_super) {
      ...
      ResourceTimelineLanesBody.prototype.render = function (props, state, context) {
          ...
          return (h("tbody", null, props.rowNodes.map(function (node, index) {
              if (node.group) {
                  return (h(DividerRow, { key: node.id, elRef: rowElRefs.createRef(index), groupValue: node.group.value, renderingHooks: node.group.spec, innerHeight: innerHeights[index] || '' }));
              }
              else if (node.resource) {
                  var resource = node.resource;
                  return (h(ResourceTimelineLane, __assign({ key: node.id, elRef: rowElRefs.createRef(index) }, props.splitProps[resource.id], { resource: resource, dateProfile: props.dateProfile, dateProfileGenerator: props.dateProfileGenerator, tDateProfile: props.tDateProfile, nowDate: props.nowDate, todayRange: props.todayRange, nextDayThreshold: context.nextDayThreshold, businessHours: resource.businessHours || props.fallbackBusinessHours, innerHeight: innerHeights[index] || '', timelineCoords: props.slatCoords, onHeightChange: props.onRowHeightChange })));
              }
          })));
      };
          ...
          return (h(ScrollGrid, { ref: this.scrollGridRef, forPrint: props.forPrint, liquid: !props.isHeightAuto, colGroups: [
              ...
              ], sections: [
                  {
                      ...
                      chunks: [
                          ...
                          { outerContent: (h("td", { ref: this.spreadsheetResizerElRef, rowSpan: 2, class: 'fc-resource-timeline-divider fc-divider ' + theme.getClass('tableCellShaded') })) },
                          {
  ...
  exports.CLIENT_HEIGHT_WIGGLE = CLIENT_HEIGHT_WIGGLE;
